...
from SO_100.tasks.grasp_object.grasp_object_env_cfg import (
    GraspObjectEnvCfg,
    EventCfgFineTune,
...
@configclass
class SoArm100GraspObjectFinetuneEnvCfg(SoArm100GraspObjectEnvCfg):
    ...
    def __post_init__(self):
        ...
        # rigid_props set here override each asset's rigid_props (see MultiAssetSpawnerCfg).
        self.scene.object = RigidObjectCfg(
            prim_path="{ENV_REGEX_NS}/Object",
...
@configclass
class SoArm100GraspObjectFinetuneEnvCfg_PLAY(SoArm100GraspObjectFinetuneEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.scene.num_envs = 50
        self.scene.env_spacing = 2.5
...
# SoArm100GraspObjectEnvCfg and only replaces the spawned object.
# Use these after pretraining on the multi-object env to fine-tune a
# dedicated policy for a single object type.
# ---------------------------------------------------------------------------

@configclass
class SoArm100GraspBoltFinetuneEnvCfg(SoArm100GraspObjectEnvCfg):
    def __post_init__(self):
        super().__post_init__()
...
@configclass
class SoArm100GraspBoltFinetuneEnvCfg_PLAY(SoArm100GraspBoltFinetuneEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.scene.num_envs = 50
        self.scene.env_spacing = 2.5
...
@configclass
class SoArm100GraspGearFinetuneEnvCfg(SoArm100GraspObjectEnvCfg):
    def __post_init__(self):
        super().__post_init__()
...
@configclass
class SoArm100GraspGearFinetuneEnvCfg_PLAY(SoArm100GraspGearFinetuneEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.scene.num_envs = 50
        self.scene.env_spacing = 2.5
...
@configclass
class SoArm100GraspNutFinetuneEnvCfg(SoArm100GraspObjectEnvCfg):
    def __post_init__(self):
        super().__post_init__()
...
@configclass
class SoArm100GraspNutFinetuneEnvCfg_PLAY(SoArm100GraspNutFinetuneEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.scene.num_envs = 50
        self.scene.env_spacing = 2.5
...
@configclass
class SoArm100GraspPegFinetuneEnvCfg(SoArm100GraspObjectEnvCfg):
    def __post_init__(self):
        super().__post_init__()
...
@configclass
class SoArm100GraspPegFinetuneEnvCfg_PLAY(SoArm100GraspPegFinetuneEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.scene.num_envs = 50
        self.scene.env_spacing = 2.5
...
@configclass
class SoArm100GraspBoxFinetuneEnvCfg(SoArm100GraspObjectEnvCfg):
    def __post_init__(self):
        super().__post_init__()
...
@configclass
class SoArm100GraspBoxFinetuneEnvCfg_PLAY(SoArm100GraspBoxFinetuneEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.scene.num_envs = 50
        self.scene.env_spacing = 2.5

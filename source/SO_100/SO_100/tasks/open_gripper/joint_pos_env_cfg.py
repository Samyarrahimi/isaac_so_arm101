...
from SO_100.tasks.open_gripper.robots import SO_ARM100_CAMERA_CFG
from SO_100.tasks.open_gripper.open_gripper_env_cfg import OpenGripperEnvCfg
...
class SoArm100OpenGripperEnvCfg(OpenGripperEnvCfg):
    def __post_init__(self):
        ...
        #     use_default_offset=True,
        #     preserve_order=True,
        #     clip={"Gripper": (0.026, 0.698)},  # OLD LIMITS gripper joint limits
        # )


@configclass
class SoArm100OpenGripperEnvCfg_PLAY(SoArm100OpenGripperEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()

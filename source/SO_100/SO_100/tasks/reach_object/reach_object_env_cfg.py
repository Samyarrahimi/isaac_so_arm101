...
@configclass
class ReachObjectSceneCfg(InteractiveSceneCfg):
...
@configclass
class ReachObjectEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the reach end-effector pose tracking environment."""

    # Scene settings
    scene: ReachObjectSceneCfg = ReachObjectSceneCfg(num_envs=4096, env_spacing=2.5)
    # Basic settings

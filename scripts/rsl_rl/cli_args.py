...
def add_rsl_rl_args(parser: argparse.ArgumentParser):
    ...
    arg_group.add_argument("--load_experiment_name", type=str, default=None, help="Experiment name to load checkpoint from (if different from the current experiment, e.g. loading pretrained weights into a finetune run).")
